...
exports.submitContact = async function (req, res, next) {
  ...
  try {
    ...
    <p>We appreciate your interest in ${doesPetExist.name} and one of our staff members will reach to you shortly! Below is a copy of the message you sent us for your personal records:</p>
    <p><em>${ourObject.comment}</em></p>`
    })

    const promise2 = transport.sendMail({
      to: "writer@whatever.com",
      from: "writer@whatever.com",
